        ...
        skills: {
            ...
            categories: [
                ...
                },
                {
                    ...
                    list: ["ASP.NET MVC", "ASP.NET Core", "Spring Boot", "Spring Web Flow", "Rails", "React", "JSF", "PrimeFaces", "Flutter", "Vue.js", "Angular", "jQuery"]
                },
                {
                    name: "Cloud & DevOps",
                    list: ["AWS (EC2, Lambda, S3, RDS, EventBridge)", "Azure (VMs, Functions, Blob, DB, Event Grid)", "GitHub Actions", "CI/CD", "Git", "DevOps"]
                },
                {
        ...
        skills: {
            ...
            categories: [
                ...
                },
                {
                    ...
                    list: ["ASP.NET MVC", "ASP.NET Core", "Spring Boot", "Spring Web Flow", "Rails", "JSF", "PrimeFaces", "Flutter", "Vue.js", "AngularJS", "jQuery"]
                },
                {
                    name: "Cloud & DevOps",
                    list: ["AWS (EC2, Lambda, S3, RDS, EventBridge)", "Azure (VMs, Functions, Blob, DB, Event Grid)", "GitHub Actions", "CI/CD", "Git", "DevOps"]
                },
                {
                    ...
                    list: ["PostgreSQL", "MSSQL", "MySQL", "MongoDB", "Entity Framework", "NHibernate", "Modelagem de Dados", "Integridade de Dados"]
                },
                {
                    name: "Arquitetura & Boas Práticas",
                    list: ["APIs RESTful", "Integrações Webhook", "Microsserviços", "API Gateway", "JWT", "OAuth 2.0", "DDD", "Padrões de Projeto", "BDD", "TDD", "Ágil"]
                },
                {
